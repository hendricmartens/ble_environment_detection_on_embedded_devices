...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FP_SOFTABI, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LVGL_USE_FILESYSTEM, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LVGL_USE_THEME_MATERIAL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LVGL_THEME_MATERIAL_LIGHT, 1);
